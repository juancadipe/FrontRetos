...
function pintarRespuesta2(respuesta){
    ...
    myTable+="<td>Nombre del Cliente</td>";
    myTable+="<td>Edad</td>";
...
function guardarInformacionCliente(){
    let var2 = {
        ...
        url:"http://150.230.33.50:8080/api/Client/save",
...
function actualizarInformacionCliente(idElemento){
    ...
    $.ajax({
        url:"http://150.230.33.50:8080/api/Client/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCliente(idElemento){
    ...
    $.ajax({
        url:"http://150.230.33.50:8080/api/Client/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
